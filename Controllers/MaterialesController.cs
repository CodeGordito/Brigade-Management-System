...
namespace GestorBrigadasComunitarias.Controllers
{
    public class MaterialesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Materiales
                .Include(m => m.Jornada);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Cantidad,UnidadMedida,JornadaId")] Material material)
        {
            ...
            ViewData["JornadaId"] = new SelectList(_context.Jornadas, "Id", "Lugar", material.JornadaId);
            return View(material);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Cantidad,UnidadMedida,JornadaId")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
