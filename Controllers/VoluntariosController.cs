...
namespace GestorBrigadasComunitarias.Controllers
{
    public class VoluntariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Cedula,Telefono,Correo")] Voluntario voluntario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Cedula,Telefono,Correo")] Voluntario voluntario)
        {
            if (id != voluntario.Id)
            {
                return NotFound();
